...
final class Fgeditorswitcher extends CMSPlugin
{
	...
	protected function getEditorSelector(string $current, string $name = ''): string
	{
		...
		if (!$assetsRegistered)
		{
			...
			$wa->registerAndUseStyle('plg.editors.fgeditorswitcher', 'media/plg_fgeditorswitcher/css/fgeditorswitcher.css', ['version' => '2.0.1']);
			$wa->registerAndUseScript('plg.editors.fgeditorswitcher', 'media/plg_fgeditorswitcher/js/fgeditorswitcher.js', ['version' => '2.0.1'], ['defer' => true]);
		}
		...
		return '<!-- plg_fgeditorswitcher v2.0.1 -->'
